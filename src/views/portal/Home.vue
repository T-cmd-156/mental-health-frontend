...
<script setup>
import { ref } from 'vue'
import { notices as noticesData, wiki as wikiData, articles as articlesData } from '../../api/mock'
import { useHomeActions } from '../../api/portal'

const notices = ref(noticesData)
const wiki = ref(wikiData)
const articles = ref(articlesData)

const { goLogin, goAppointment, goDetail } = useHomeActions()
</script>
<style>
.home {
  min-height: 100vh;
