...
const loadData = async () => {
  try {
    const res = await request.get('/api/leader/workbench/stats')
  ...
  try {
    const res = await request.get('/api/leader/workbench/todo')
    if (res.code === 200) {
  ...
  try {
    const res = await request.get('/api/leader/workbench/colleges')
    if (res.code === 200) {
