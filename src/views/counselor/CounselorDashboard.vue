<template>
  <div class="dashboard">
    ...
    <section class="card charts">
      ...
      <el-radio-group v-model="chartDimension" size="small" class="chart-tabs">
...
const shortcuts = [
  { label: '发起预约', path: '/appointment/select', icon: Calendar },
  ...
  { label: '团体活动管理', path: '/activity/manage', icon: ChatDotRound },
  { label: '排班管理', path: '/counselor/schedule', icon: Clock },
  { label: '咨询记录修改申请', path: '#', icon: EditPen },
  { label: '联系咨询师', path: '/peer-support', icon: Connection },
]
