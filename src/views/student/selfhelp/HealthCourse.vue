...
import { getHealthCourseList, getHealthCourseDetail, enrollHealthCourse } from '@/api/selfHelp'
import { User, Clock, Reading, Star, Lock, CircleCheck, Select, Share, ChatDotRound } from '@element-plus/icons-vue'
...
onMounted(() => {
  getHealthCourseList().then(res => {
    ...
    relatedCourses.value = res?.slice(0, 4) || []
