...
const loadData = async () => {
  try {
    const res = await request.get('/api/college/workbench/stats')
  ...
  try {
    const res = await request.get('/api/college/workbench/todo')
    if (res.code === 200) {
  ...
  try {
    const res = await request.get('/api/college/workbench/crisis')
    if (res.code === 200) {
