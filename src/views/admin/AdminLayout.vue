...
<aside class="menu">
  ...
  <template v-if="role === 'tutor'">
    ...
    <div class="item" :class="{ active: isExternalActive('/activity/manage') }" @click="router.push('/activity/manage')">活动管理</div>
  </template>
  ...
  <template v-else>
    ...
    <!-- 请假管理：咨询师、心理中心可见 -->
    <div class="item" v-if="['counselor','center'].includes(role)" :class="{ active: isExternalActive('/leave/list') }" @click="router.push('/leave/list')">请假管理</div>
    ...
    <!-- 团体活动管理：咨询师、心理中心可见 -->
    <div class="item" v-if="['counselor','center'].includes(role)" :class="{ active: isExternalActive('/activity/manage') }" @click="router.push('/activity/manage')">团体活动管理</div>
