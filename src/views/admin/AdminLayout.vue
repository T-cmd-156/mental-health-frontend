...
<aside class="menu">
  ...
  <template v-if="role === 'tutor'">
    <div class="item" @click="go('tutor-workbench')">工作台</div>
    <div class="item" @click="go('tutor-students')">学生管理</div>
    <div class="item" @click="go('tutor-crisis-report')">危机上报</div>
    <div class="item" @click="go('tutor-assessment')">测评查看</div>
    <div class="item" @click="go('tutor-report')">月报填写</div>
    <div class="item" @click="router.push('/activity/manage')">活动管理</div>
  </template>

  <!-- 院系领导专属菜单 -->
  <template v-else-if="role === 'college'">
    <div class="item" @click="go('college-workbench')">工作台</div>
    <div class="item" @click="go('college-statistics')">数据统计</div>
    <div class="item" @click="go('college-report')">报表查看</div>
    <div class="item" @click="go('college-crisis')">危机管理</div>
    <div class="item" @click="go('college-students')">学生管理</div>
    <div class="item" @click="go('college-manage')">院系管理</div>
  </template>

  <!-- 校领导专属菜单 -->
  <template v-else-if="role === 'leader'">
    <div class="item" @click="go('leader-workbench')">工作台</div>
    <div class="item" @click="go('leader-statistics')">数据统计</div>
    <div class="item" @click="go('leader-report')">报表查看</div>
    <div class="item" @click="go('leader-crisis')">危机管理</div>
    <div class="item" @click="go('leader-colleges')">院系管理</div>
  </template>

  <!-- 其他角色（管理员、心理中心、咨询师）菜单 -->
  <template v-else>
    <!-- 所有人可见 -->
