          ...
          <el-form :model="globalConfig" label-width="140px" class="config-form">
            ...
            <el-form-item label="结果可见范围">
              <el-checkbox-group v-model="globalConfig.resultViewRoles">
                <el-checkbox label="student">学生本人</el-checkbox>
                <el-checkbox label="counselor">咨询师</el-checkbox>
                <el-checkbox label="center">心理中心</el-checkbox>
                <el-checkbox label="tutor">辅导员</el-checkbox>
              </el-checkbox-group>
            </el-form-item>
            <el-form-item>
