...
import { createRecordAsync, updateRecordAsync, autosaveRecordAsync, getRecordsByCounselorAsync } from '../../api/record'
...
const form = ref<any>({
  ...
  counselor_id: localStorage.getItem('user_id') || localStorage.getItem('counselor_id') || '',
  consultant_name: localStorage.getItem('user_name') || '',
